...
class KR_LMS_Admin {
    ...
    public function scripts($hook) {
        if ($hook !== "toplevel_page_cb-certificates" && $hook !== "toplevel_page_kr-lms") return;
            ...
            <div class="cb-modal-content">
                ...
                <div class="cb-modal-body">
                    ...
                    <div class="cb-form-group">
                        ...
                        <input type="text" id="cb-father-name" class="cb-input" placeholder="e.g. Md Mollbor Rahman">
                    </div>

                    <div class="cb-form-group">
                        <label>Mother's Name</label>
                        <input type="text" id="cb-mother-name" class="cb-input" placeholder="e.g. Afiya Khanomhas">
                    </div>
                    ...
                    <div class="cb-form-group">
                        ...
                        <input type="text" id="cb-date-range" class="cb-input" placeholder="e.g. 28 May, 2024 to 05 Dec, 2024">
                    </div>
